...
public class FavoriteAdapter extends RecyclerView.Adapter<FavoriteAdapter.ViewHolder> implements PraiseView {
    private Context context;
    private List<GetFavorite.DataBean> data;
    ...
    public FavoriteAdapter(Context context, List<GetFavorite.DataBean> data) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        PlayerView playerView = new PlayerView((Activity) context,player)
                .setTitle(String.valueOf(data.get(position).workDesc))
